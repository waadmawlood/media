...
class Media extends Model
{
    ...
    {
        return sprintf('%s%s%s',config('app.url'),config('media.shortcut'),$this->attributes['base_name']);
    }
    ...
    {
        return $date->format(config('media.format_date'));
    }
